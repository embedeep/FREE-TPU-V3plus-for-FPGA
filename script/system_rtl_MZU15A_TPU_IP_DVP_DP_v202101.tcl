...
# import_files -fileset constrs_1 ./top.xdc
add_files    -fileset constrs_1 -copy_to $PRJPATH/$PRJNAME/$PRJNAME.srcs/constrs_1 ${contrs_PATH}/top.xdc
...
set wfid [ open "$PRJPATH/$PRJNAME/$PRJNAME.srcs/constrs_1/top.xdc" a ]

puts $wfid "##### DVPin #####"
puts $wfid "create_clock -name sdvp_clk -period 10 \[get_ports DVPin_CLOCK\]"
# ============== J3 ======================
puts $wfid "set_property PACKAGE_PIN N8      \[get_ports XCLK\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports XCLK\]"
...
puts $wfid "set_property PACKAGE_PIN V7      \[get_ports DVPin_HREF\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports DVPin_HREF\]"
puts $wfid "set_property PACKAGE_PIN V8      \[get_ports DVPin_VSYNC\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports DVPin_VSYNC\]"
puts $wfid "set_property PACKAGE_PIN L10     \[get_ports {DVPin_DATA\[0\]}\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports {DVPin_DATA\[0\]}\]"
puts $wfid "set_property PACKAGE_PIN M10     \[get_ports {DVPin_DATA\[1\]}\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports {DVPin_DATA\[1\]}\]"
puts $wfid "set_property PACKAGE_PIN R9      \[get_ports {DVPin_DATA\[2\]}\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports {DVPin_DATA\[2\]}\]"
puts $wfid "set_property PACKAGE_PIN R10     \[get_ports {DVPin_DATA\[3\]}\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports {DVPin_DATA\[3\]}\]"
puts $wfid "set_property PACKAGE_PIN L11     \[get_ports {DVPin_DATA\[4\]}\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports {DVPin_DATA\[4\]}\]"
puts $wfid "set_property PACKAGE_PIN M11     \[get_ports {DVPin_DATA\[5\]}\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports {DVPin_DATA\[5\]}\]"
puts $wfid "set_property PACKAGE_PIN W11     \[get_ports {DVPin_DATA\[6\]}\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports {DVPin_DATA\[6\]}\]"
puts $wfid "set_property PACKAGE_PIN W12     \[get_ports {DVPin_DATA\[7\]}\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports {DVPin_DATA\[7\]}\]"
puts $wfid "set_property PACKAGE_PIN P10     \[get_ports IIC_0_scl_io\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports IIC_0_scl_io\]"
puts $wfid "set_property PACKAGE_PIN P9      \[get_ports IIC_0_sda_io\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports IIC_0_sda_io\]"
puts $wfid "set_property PACKAGE_PIN M15     \[get_ports fpga_io_en\]"
puts $wfid "set_property IOSTANDARD LVCMOS18 \[get_ports fpga_io_en\]"
puts $wfid "set_property SLEW FAST           \[get_ports IIC_0_scl_io\]"
puts $wfid "set_property PULLUP true         \[get_ports IIC_0_scl_io\]"
puts $wfid "set_property SLEW FAST           \[get_ports IIC_0_sda_io\]"
puts $wfid "set_property PULLUP true         \[get_ports IIC_0_sda_io\]"
puts $wfid "set_property CLOCK_DEDICATED_ROUTE FALSE \[get_nets DVPin_CLOCK_IBUF_inst/O\]"
puts $wfid "set_false_path -from clk_out1_system_clk_wiz_0_0 -to sdvp_clk"
puts $wfid "set_false_path -from sdvp_clk -to clk_out1_system_clk_wiz_0_0"
# ===================================================================================
close $wfid
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DVPin_CLOCK [ create_bd_port -dir I -type clk -freq_hz 100000000 DVPin_CLOCK ]
  set DVPin_DATA [ create_bd_port -dir I -from 7 -to 0 DVPin_DATA ]
  set DVPin_HREF [ create_bd_port -dir I DVPin_HREF ]
  set DVPin_VSYNC [ create_bd_port -dir I DVPin_VSYNC ]
  set XCLK [ create_bd_port -dir O -type clk XCLK ]
  set fpga_io_en [ create_bd_port -dir O -from 0 -to 0 fpga_io_en ]

  # Create instance: EEP_DVP_Top_0, and set properties
  set block_name EEP_DVP_Top
  set block_cell_name EEP_DVP_Top_0
  if { [catch {set EEP_DVP_Top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $EEP_DVP_Top_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: EEP_TPU_0, and set properties
  set EEP_TPU_0 [ create_bd_cell -type ip -vlnv user.org:user:EEP_TPU:1.0 EEP_TPU_0 ]

  # Create instance: clk_wiz_0, and set properties
  set clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_0 ]
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {105.559} \
   CONFIG.CLKOUT1_PHASE_ERROR {141.590} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {250} \
   CONFIG.CLKOUT2_JITTER {159.280} \
...
SPI Flash#Feedback Clk##CAN 1#CAN 1####SD 0#SD 0#SD 0#SD 0#####SD 0#SD 0##SD\
0##PMU GPI 0#DPAUX#DPAUX#DPAUX#DPAUX####UART 0#UART 0##PMU GPO 5##SD 1#SD 1#SD\
...
3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3}\
   ...
   CONFIG.PSU__CRL_APB__SDIO0_REF_CTRL__ACT_FREQMHZ {50.000000} \
   ...
   CONFIG.PSU__CRL_APB__SDIO1_REF_CTRL__DIVISOR0 {15} \
   ...
   CONFIG.PSU__PMU__GPO5__POLARITY {high} \
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;1|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1}\
  ...
  connect_bd_intf_net -intf_net EEP_DVP_Top_0_M0_AXI [get_bd_intf_pins EEP_DVP_Top_0/M0_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net EEP_TPU_0_M00_AXI [get_bd_intf_pins EEP_TPU_0/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins EEP_TPU_0/s00_axi] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins EEP_DVP_Top_0/s00_axi] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net DVPin_CLOCK_1 [get_bd_ports DVPin_CLOCK] [get_bd_pins EEP_DVP_Top_0/DVPin_CLOCK]
  connect_bd_net -net DVPin_DATA_1 [get_bd_ports DVPin_DATA] [get_bd_pins EEP_DVP_Top_0/DVPin_DATA]
  connect_bd_net -net DVPin_HREF_1 [get_bd_ports DVPin_HREF] [get_bd_pins EEP_DVP_Top_0/DVPin_HREF]
  connect_bd_net -net DVPin_VSYNC_1 [get_bd_ports DVPin_VSYNC] [get_bd_pins EEP_DVP_Top_0/DVPin_VSYNC]
  connect_bd_net -net EEP_DVP_Top_0_intr_rx [get_bd_pins EEP_DVP_Top_0/intr_rx] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net EEP_TPU_0_tpu_intr [get_bd_pins EEP_TPU_0/tpu_intr] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins EEP_DVP_Top_0/M0_AXI_clk] [get_bd_pins EEP_DVP_Top_0/s00_axi_aclk] [get_bd_pins EEP_TPU_0/M00_AXI_aclk] [get_bd_pins EEP_TPU_0/axi_core_clk] [get_bd_pins EEP_TPU_0/s00_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_0_250M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports XCLK] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_250M/dcm_locked]
  connect_bd_net -net rst_clk_wiz_0_300M_peripheral_aresetn [get_bd_pins EEP_DVP_Top_0/M0_AXI_rstn] [get_bd_pins EEP_DVP_Top_0/s00_axi_aresetn] [get_bd_pins EEP_TPU_0/M00_AXI_aresetn] [get_bd_pins EEP_TPU_0/axi_core_rstn] [get_bd_pins EEP_TPU_0/s00_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_250M/peripheral_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins EEP_TPU_0/clk_100M_aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins EEP_DVP_Top_0/DVPout_CLK] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_ports fpga_io_en] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins EEP_TPU_0/clk_100M] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_clk_wiz_0_250M/ext_reset_in] [get_bd_pins rst_ps8_0_99M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces EEP_DVP_Top_0/M0_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces EEP_DVP_Top_0/M0_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces EEP_DVP_Top_0/M0_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces EEP_TPU_0/M00_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces EEP_TPU_0/M00_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces EEP_TPU_0/M00_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0xA00C0000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs EEP_DVP_Top_0/s00_axi/reg0] -force
  assign_bd_address -offset 0xA0000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs EEP_TPU_0/s00_axi/reg0] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces EEP_DVP_Top_0/M0_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces EEP_TPU_0/M00_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
...
set_property synth_checkpoint_mode None [get_files  $PRJPATH/$PRJNAME/$PRJNAME.srcs/sources_1/bd/system/system.bd]
generate_target all [get_files  $PRJPATH/$PRJNAME/$PRJNAME.srcs/sources_1/bd/system/system.bd]

make_wrapper -files [get_files $PRJPATH/$PRJNAME/$PRJNAME.srcs/sources_1/bd/system/system.bd] -top
add_files -norecurse $PRJPATH/$PRJNAME/$PRJNAME.srcs/sources_1/bd/system/hdl/system_wrapper.v
...
reset_run synth_1
launch_runs -jobs $JOB_NUM synth_1
wait_on_run synth_1

reset_run impl_1
launch_runs impl_1 -to_step write_bitstream -jobs $JOB_NUM
wait_on_run impl_1
